...
export default function Panduan() {
  return <main>
    ...
    <ScrollReveal />
    <SiteHeader base="/" active="panduan" enHref="/en/panduan" zhHref="/zh/panduan" />
    ...
    <section className="section" id="kandungan" tabIndex={-1}><div className="container">
      ...
      <div style={{ maxWidth: 700, marginBottom: 'var(--s7)' }} data-reveal>
        ...
        <ul style={{ paddingLeft: 20, margin: '16px 0', display: 'grid', gap: 10 }}>
          ...
          <li><b>Pertimbangkan sedikit lebihan</b> — sesetengah organisasi menambah beberapa unit tambahan untuk staf baharu atau gantian, tetapi ini pilihan anda sepenuhnya, bukan syarat.</li>
    ...
    <section className="final-cta"><div className="container" data-reveal>
      ...
      <h2>Kongsi keperluan anda.<br /><em>Kami menguruskan selebihnya.</em></h2>
      <p>Hubungi Syrius melalui WhatsApp untuk berbincang tentang reka bentuk, kuantiti, harga dan penghantaran.</p>
