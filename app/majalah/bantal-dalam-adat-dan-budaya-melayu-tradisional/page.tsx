  ...
  return <main>
    ...
    <article className="section" id="artikel" tabIndex={-1}><div className="container" style={{ maxWidth: 720 }}>
      ...
      <div data-reveal>
        ...
        <p>Dalam kalangan penutur Inggeris, bantal jenis ini turut dikenali sebagai &ldquo;Dutch wife&rdquo;. Nama ini sering dikaitkan dengan zaman penjajahan Belanda di Hindia Timur (kini Indonesia) pada abad ke-19, apabila ramai pegawai dan askar Belanda yang berkhidmat di rantau tropika ini datang tanpa isteri atau keluarga, lalu mencari keselesaan pada bantal panjang yang telah digunakan penduduk tempatan. Walau bagaimanapun, dakwaan bahawa bantal ini benar-benar &ldquo;dicipta&rdquo; oleh orang Belanda masih tidak dapat disahkan secara muktamad, dan sesetengah sumber turut menyifatkannya sekadar cerita popular yang diwarisi turun-temurun. Terdapat juga versi lain yang menyebut gelaran &ldquo;Dutch wife&rdquo; sebenarnya berasal daripada sindiran orang Inggeris terhadap saingan kolonial mereka, iaitu Belanda, sejajar dengan penggunaan perkataan &ldquo;Dutch&rdquo; bernada merendah-rendah yang sudah lama wujud dalam bahasa Inggeris, seperti dalam ungkapan &ldquo;Dutch courage&rdquo;.</p>
      ...
      <div data-reveal>
        ...
        <p>Perlu diingatkan bahawa jenis dan bilangan bantal pada pelamin boleh berbeza-beza mengikut negeri, keturunan diraja setempat dan adat sesebuah kampung, dan susunan yang dinyatakan di atas tidak semestinya seragam di seluruh Alam Melayu, memandangkan tidak banyak sumber akademik yang mendokumentasikannya secara terperinci bagi setiap wilayah.</p>
      </div>
      ...
      <div data-reveal>
        ...
        <p>Salah satu pantang larang Melayu tradisional yang masih disebut sehingga kini ialah larangan duduk di atas bantal. Menurut Wikipedia Bahasa Melayu, kepercayaan popular masyarakat Melayu menyatakan sesiapa yang duduk di atas bantal boleh ditimpa bisul. Sumber yang sama turut mencatatkan sebab yang lebih praktikal di sebalik larangan tersebut, iaitu supaya bantal terjaga daripada koyak atau pecah, dan kerana dianggap tidak sopan meletakkan punggung di atas kain yang sepatutnya mengalas kepala.</p>
