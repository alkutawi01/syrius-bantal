...
export default function Artikel() {
  return <main>
    ...
    <ScrollReveal />
    <SiteHeader base="/" active="majalah" enHref="/en/majalah/bantal-dalam-adat-dan-budaya-melayu-tradisional" zhHref="/zh/majalah/bantal-dalam-adat-dan-budaya-melayu-tradisional" />
