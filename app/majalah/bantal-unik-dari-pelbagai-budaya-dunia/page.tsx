  ...
  return <main>
    ...
    <article className="section" id="artikel" tabIndex={-1}><div className="container" style={{ maxWidth: 720 }}>
      ...
      <div data-reveal>
        ...
        <p>Sesetengah pengeluar dan penulis barangan tradisional Jepun mengaitkan amalan mengisi bantal dengan kulit soba ini dengan budaya kitar semula pada zaman Edo (1603-1867), ketika sisa hasil pengisaran soba dimanfaatkan sepenuhnya dan tidak dibuang begitu sahaja. Walau bagaimanapun, sumber lain pula mengesan penggunaan kulit soba sebagai isian bantal sejak lebih awal, sekitar abad ke-15, dan tarikh tepat bilakah amalan ini sebenarnya bermula tidak dapat disahkan secara akademik serta kekal sebagai perkara yang tidak jelas dalam rekod sejarah bertulis. Yang lebih pasti ialah bantal kulit soba kekal digunakan secara meluas di Jepun sehingga ke hari ini, malah sering dikaitkan sebagai penawar tradisional bagi masalah otot tegang di bahu dan tengkuk yang dalam bahasa Jepun disebut <em lang="ja" style={{ fontStyle: 'normal' }}>katakori</em>.</p>
      </div>
      ...
      <div data-reveal>
        ...
        <p>Bagi masyarakat Turkana yang hidup secara nomad di Kenya, penyokong kepala mereka direka lebih ringan dan mudah dibawa, malah dilengkapi gelung atau tali kulit pada tapaknya supaya boleh dibawa bersama semasa berpindah tempat. Menariknya, masyarakat Boni, turut dikenali sebagai Aweer, yang majoritinya tinggal di kawasan pantai Lamu dan Tana River di Kenya (dengan sebilangan kecil turut terdapat di selatan Somalia), pula sengaja mengukir penyokong kepala yang agak tidak stabil supaya tidur mereka tidak terlalu lena, membolehkan mereka kekal peka untuk melindungi ternakan daripada ancaman pada waktu malam. Di Ethiopia pula, pelbagai kumpulan seperti Oromo, Sidaama dan Gurage turut mencipta penyokong kepala kayu dengan corak geometri yang pelbagai, yang secara umumnya berfungsi untuk mengekalkan gaya rambut semasa tidur serta menunjukkan status pemiliknya, berbanding membawa makna kerohanian yang mendalam seperti sesetengah tradisi lain di benua yang sama.</p>
