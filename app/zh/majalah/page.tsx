...
const articles: [string, string, string, ReactNode, number][] = [
  ...
  ['idea-hadiah-korporat-bermakna', '为何实用的企业礼品更容易让品牌被记住？', '促销品行业研究显示，真正实用的礼品远比一次性纪念品更让人印象深刻。参考资料、原则与选择方法。', <svg key="i3" viewBox="0 0 24 24" fill="none" aria-hidden="true"><rect x="3" y="8" width="18" height="4" rx="1" stroke="currentColor" strokeWidth="1.5" /><path d="M5 12v8a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-8M12 8v13" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" /><path d="M12 8c-1.5-3-3-4-4.5-4S5 5 5 6.5 6.5 8 8 8h4Zm0 0c1.5-3 3-4 4.5-4S19 5 19 6.5 17.5 8 16 8h-4Z" stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round" /></svg>, 3],
  ['jenis-pengisian-bantal', '枕头填充材料类型指南', '聚酯纤维、羽绒、木棉与记忆棉作为枕头填充材料的差异——从舒适度、耐用性与保养方式来看。', <svg key="i2" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M4 15c2-3 4 3 6 0s4-3 6 0 4 3 4 0" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" /><rect x="3" y="15" width="18" height="5" rx="1.5" stroke="currentColor" strokeWidth="1.4" /></svg>, 2],
  ['sejarah-evolusi-bantal', '枕头的历史与演变', '追溯枕头的历史：从古埃及、美索不达米亚、中国与日本的硬质头枕，到欧洲逐渐普及的软质羽绒枕。', <svg key="i8" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M12 2v4M12 18v4M4.9 4.9l2.8 2.8M16.3 16.3l2.8 2.8M2 12h4M18 12h4M4.9 19.1l2.8-2.8M16.3 7.7l2.8-2.8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" /><circle cx="12" cy="12" r="3.5" stroke="currentColor" strokeWidth="1.5" /></svg>, 8],
];
