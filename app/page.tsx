...
export default function Home() {
  return <main>
    ...
    <footer><div className="container footer-grid"><div><Wordmark /><p>Bantal sublimasi korporat untuk hadiah yang lebih bermakna.</p></div><div><p className="footer-label">HUBUNGI</p><a href="https://wa.me/601154498790">+60 11-5449 8790</a><a href="mailto:syriusmalaysia@gmail.com">syriusmalaysia@gmail.com</a></div><div><p className="footer-label">STUDIO</p><p>PT 428, Pusat Perniagaan<br />Bandar Baru Tunjong, Kota Bharu.</p></div></div><div className="container copyright">© 2026 Syrius Malaysia <span>Wear Your Vision</span></div></footer>
  </main>;
}
