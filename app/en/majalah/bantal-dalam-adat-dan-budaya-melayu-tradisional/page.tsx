...
export default function ArtikelEn() {
  return <main>
    ...
    <div className="announcement"><div className="container"><span>Corporate Gifting &amp; Branded Cushions</span><a href="/majalah/bantal-dalam-adat-dan-budaya-melayu-tradisional" lang="ms" hrefLang="ms">Bahasa Melayu</a></div></div>
    ...
    <article className="section" id="artikel-en" tabIndex={-1}><div className="container" style={{ maxWidth: 720 }}>
      ...
      <div data-reveal>
        ...
        <p>Taboos like this actually reflect a larger value in Malay culture: respect for the head as a body part considered noble and not to be treated carelessly. The warning of a physical consequence like boils functions as an educational device, particularly for children, to encourage respect for items closely associated with the head. There's no medical evidence supporting a literal link between sitting on a pillow and developing boils, and this taboo is more accurately understood as a value-teaching tool passed down orally from one generation to the next.</p>
