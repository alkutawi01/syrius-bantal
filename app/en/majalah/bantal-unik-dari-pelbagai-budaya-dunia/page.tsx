...
export default function ArtikelEn() {
  return <main>
    ...
    <div className="announcement"><div className="container"><span>Corporate Gifting &amp; Branded Cushions</span><a href="/majalah/bantal-unik-dari-pelbagai-budaya-dunia" lang="ms" hrefLang="ms">Bahasa Melayu</a><a href="/zh/majalah/bantal-unik-dari-pelbagai-budaya-dunia" lang="zh" hrefLang="zh">中文</a></div></div>
      ...
      <div className="nav-right">
        ...
        <MobileMenu
          links={[
            ...
            ['/zh/majalah/bantal-unik-dari-pelbagai-budaya-dunia', '中文'],
          ]}
