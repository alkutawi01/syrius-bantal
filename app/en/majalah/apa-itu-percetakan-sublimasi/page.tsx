...
export default function ArtikelEn() {
  return <main>
    ...
    <div className="announcement"><div className="container"><span>Corporate Gifting &amp; Branded Cushions</span><a href="/majalah/apa-itu-percetakan-sublimasi" lang="ms" hrefLang="ms">Bahasa Melayu</a><a href="/zh/majalah/apa-itu-percetakan-sublimasi" lang="zh" hrefLang="zh">中文</a></div></div>
      ...
      <div className="nav-right">
        ...
        <MobileMenu
          links={[
            ...
            ['/zh/majalah/apa-itu-percetakan-sublimasi', '中文'],
          ]}
