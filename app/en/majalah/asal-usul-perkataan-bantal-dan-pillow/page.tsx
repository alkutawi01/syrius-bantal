...
export default function ArtikelEn() {
  return <main>
    ...
    <div className="announcement"><div className="container"><span>Corporate Gifting &amp; Branded Cushions</span><a href="/majalah/asal-usul-perkataan-bantal-dan-pillow" lang="ms" hrefLang="ms">Bahasa Melayu</a><a href="/zh/majalah/asal-usul-perkataan-bantal-dan-pillow" lang="zh" hrefLang="zh">中文</a></div></div>
      ...
      <div className="nav-right">
        ...
        <MobileMenu
          links={[
            ...
            ['/zh/majalah/asal-usul-perkataan-bantal-dan-pillow', '中文'],
          ]}
    ...
    <article className="section" id="artikel-en" tabIndex={-1}><div className="container" style={{ maxWidth: 720 }}>
      ...
      <div data-reveal>
        ...
        <p>If the word &ldquo;bantal&rdquo; did originally refer to &ldquo;a bundle or wrapping of cloth,&rdquo; that meaning has since undergone significant broadening and narrowing to refer specifically to the head support known today. The fourth edition of <em lang="ms" style={{ fontStyle: 'italic' }}>Kamus Dewan</em>, published by Dewan Bahasa dan Pustaka, now defines &ldquo;bantal&rdquo; as a headrest or cushion made of sewn cloth, like a sack, filled with material such as kapok. The same dictionary also records several variants, such as bantal golek (a long, round bolster), bantal seraga (a round, embroidered cushion) and bantal sandar (a backrest cushion).</p>
      ...
      <div data-reveal>
        <h2 style={{ color: 'var(--ink)', fontSize: 22, letterSpacing: '-.01em', margin: '40px 0 14px' }}>Pillow: a Latin influence carried through the Germanic languages</h2>
