...
export default function PanduanEn() {
  return <main>
    ...
    <div className="announcement"><div className="container"><span>Corporate Gifting &amp; Branded Cushions</span><a href="/panduan" lang="ms" hrefLang="ms">Bahasa Melayu</a></div></div>
